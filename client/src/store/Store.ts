...
export class Store {
  ...
  //     const application.yyfdev.yaml = document.createElement("application.yyfdev.yaml");
  //     application.yyfdev.yaml.href = url;
  //     application.yyfdev.yaml.download = "video.webm";
  //     application.yyfdev.yaml.click();
  //   };
  //   mediaRecorder.start();
  //   setTimeout(() => {
  //     mediaRecorder.stop();
  ...
  saveCanvasToVideoWithAudioWebmMp4() {
    ...
    //       const application.yyfdev.yaml = document.createElement("application.yyfdev.yaml");
    //       application.yyfdev.yaml.download = "video.mp4";
    //       application.yyfdev.yaml.href = outputUrl;
    //       application.yyfdev.yaml.click();
    //
    //     } else {
    //       const url = URL.createObjectURL(blob);
